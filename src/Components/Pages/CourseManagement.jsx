...
const CourseManagement = () => {
  ...
  useEffect(() => {
    const storedMern =
      JSON.parse(localStorage.getItem("MernStackCourses")) || [];
    const storedFullStack =
      JSON.parse(localStorage.getItem("FullStackCourses")) || [];
    const storeProgramming =
      JSON.parse(localStorage.getItem("ProgrammingCourses")) || [];
    const storeFreeCourses =
      JSON.parse(localStorage.getItem("FreeCourses")) || [];
