...
const CourseManagement = () => {
  ...
  const handleAddCourse = async () => {
    try {
      ...
      await api.post("/Course/add-course", newCourse);
      notification.success({
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          <Button
            type="primary"
            onClick={() => viewLessons(record.courseId, record.name)}
          >
            View Lessons
          </Button>
          <Button
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Form.Item
            ...
            label="Time (Hours)"
            rules={[
              { required: true, message: "Please input the learning time!" },
            ]}
          >
        ...
        <Form form={form} layout="vertical">
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input the detail for the lesson!",
              },
            ]}
          >
