                ...
                <MDBRow className="g-0">
                  ...
                  <MDBCol md="8">
                    <MDBCardBody className="p-4">
                      ...
                      <MDBTypography tag="h6">Payment</MDBTypography>
                      <hr className="mt-0 mb-4" />
                      <MDBRow className="pt-1">
                        <MDBCol size="6" className="mb-3">
                          <MDBTypography tag="h6">Wallet:</MDBTypography>
                          <MDBCardText className="text-muted">$150.00</MDBCardText>
                        </MDBCol>
                        <MDBCol size="6" className="mb-3">
                          <MDBTypography tag="h6">Nạp tiền</MDBTypography>
